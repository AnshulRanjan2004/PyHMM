...
if __name__ == '__main__':
    ...
    model_file = "coins.json"  # this is the model file name - you can create one yourself and set it in this variable
    hmm = MyHmm(os.path.join(models_dir, model_file))
    print("Using the model from file: ", model_file,
          " - You can modify the parameters A, B and pi in this file to build different HMM models")
